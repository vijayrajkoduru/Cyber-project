"""CORS misconfiguration scanner — 3 origin probes."""
...
async def scan_cors(req: ScanRequest, payload=Depends(verify_scan_quota)):
    ...
    return standard_response(tool="cors", target=req.target,
        findings=findings, tests_performed=3,
        tests_summary="3 CORS probes: attacker reflection, null origin, wildcard+credentials",
