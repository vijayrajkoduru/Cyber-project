...
TECH_CVE_MAP = [{'tech': 'Apache HTTP Server',
  ...
  'severity': 'CRITICAL',
  'cvss': '9.8',
  'description': 'Path traversal and RCE vulnerability allowing unauthenticated attackers to map URLs outside document '
                 'root.'},
 ...
 {'tech': 'WordPress',
  ...
  'severity': 'MEDIUM',
  'cvss': '6.5',
  'description': 'XXE vulnerability in WordPress media library allows server-side request forgery and file '
                 'disclosure.'},
 {'tech': 'WordPress',
  'version_match': '^[34]\\.',
  'cve': 'CVE-2015-5623',
  'severity': 'MEDIUM',
  'cvss': '5.4',
  'description': 'WordPress allows remote authenticated users to bypass intended access restrictions via crafted '
                 'requests.'},
 ...
 {'tech': 'WordPress Popup Builder Plugin',
  ...
  'severity': 'CRITICAL',
  'cvss': '9.8',
  'description': 'Popup Builder plugin privilege escalation vulnerability allows subscriber-level user account '
                 'creation.'},
