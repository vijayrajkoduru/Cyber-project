"""VL-CORE loader for the Cloud module.

Same shape as tools/_payloads/webapp/_loader.py. Each module owns its own
loader so VL-CORE isolation can be enforced — cloud scanners import
ONLY from this file (or cloud/*.py / cloud/*.txt under the same dir).
"""
import json
import os
...
_BASE = str(module_root("cloud"))
assert_isolated_import("cloud", "cloud")
