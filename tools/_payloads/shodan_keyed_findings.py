"""shodan_keyed findings."""

def rule_no_key(s):
    if s.get("_api_key_present"): return None
    return {"name":"Shodan keyed scan requires SHODAN_API_KEY","severity":"INFO",
...
def rule_ok(s):
    ...
    return {"name":"Shodan keyed scan API enabled","severity":"POSITIVE",
            "evidence":"Key configured","remediation":"Scanner active.",
            "cwe":"CWE-200","owasp":"M2:2023"}
SHODAN_KEYED_FINDING_RULES = [rule_no_key, rule_ok]
