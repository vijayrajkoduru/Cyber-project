"""VL-CORE loader for the Webapp module.

Same shape as tools/_payloads/vuln/_loader.py. Each module owns its own
loader so VL-CORE isolation can be enforced — webapp scanners import
ONLY from this file (or webapp/*.py / webapp/*.txt under the same dir).
"""
import json
import os
...
_BASE = str(module_root("webapp"))
assert_isolated_import("webapp", "webapp")
