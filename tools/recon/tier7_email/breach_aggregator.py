...
async def gather(ctx):
    ...
    if not key:
        ctx.state["skipped_reason"] = "Requires breach aggregator (DeHashed / IntelX / LeakCheck) API key — set env BREACH_AGGREGATOR_API_KEY to enable. Free tiers available at vendor's site."
        return
