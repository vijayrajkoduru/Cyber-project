      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", display: "flex", alignItems: "center", height: 70 }}>
        <a href="#" style={{ display: "flex", alignItems: "center", gap: 12, textDecoration: "none" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            <img src="/logo.png" alt="logo" style={{ width: 40, height: 40, objectFit: "contain", filter: "drop-shadow(0 0 6px rgba(59,130,246,0.5))", animation: "glow 3s ease-in-out infinite" }} />
            ...
            <div style={{ width: 220, background: "#0a0f1e", borderRight: `1px solid ${C.border}`, display: "flex", flexDirection: "column", flexShrink: 0 }}>
              ...
              <div style={{ padding: "16px 12px", borderBottom: `1px solid ${C.border}` }}>
                <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 10 }}>
                  <img src="/logo.png" alt="logo" style={{ width: 26, height: 26, objectFit: "contain", filter: "drop-shadow(0 0 6px rgba(59,130,246,0.5))" }} />
        ...
        <div style={{ display: "grid", gridTemplateColumns: "2fr 1fr 1fr", gap: 48, marginBottom: 48, flexWrap: "wrap" }}>
          <div>
            <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 16 }}>
              <img src="/logo.png" alt="logo" style={{ width: 36, height: 36, objectFit: "contain", filter: "drop-shadow(0 0 6px rgba(59,130,246,0.5))" }} />
