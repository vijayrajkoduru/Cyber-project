...
const EXPLOIT_TARGETS = [
  ...
  { label:"Samba 3.x",      os:"🐧", ip:"lab_metasploitable", port:445,  service:"Samba 3.x",      cve:"CVE-2007-2447", msf:"exploit/multi/samba/usermap_script",         payload:"cmd/unix/reverse_netcat",     fmt:"raw", search:"samba usermap_script", desc:"🟢 LIVE Docker — Samba usermap shell command injection" },
